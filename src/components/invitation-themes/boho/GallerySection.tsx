...
export default function GallerySection() {
  ...
  return (
    <section ref={sectionRef} className="py-20 md:py-28 px-4 bg-[#f9f6f0] text-[#5c4a3d] relative overflow-hidden">
      <div className="max-w-7xl mx-auto relative z-10">
        <div className={`text-center mb-12 md:mb-16 ${isVisible ? 'animate-fade-in-up' : 'opacity-0'}`}>
          <span className="text-[#b89f7e] tracking-[0.5em] text-[10px] uppercase font-sans block mb-4">
            Anılarımız
          </span>
          <h2 className="font-serif text-4xl md:text-5xl text-[#5c4a3d] mb-6">
            Bizim Hikayemiz
          </h2>
          <div className="flex items-center justify-center gap-4">
            <div className="w-20 h-[1px] bg-gradient-to-r from-transparent to-[#d5cabb]/60" />
            <Heart className="w-4 h-4 text-[#b89f7e]" strokeWidth={1.5} fill="#b89f7e" fillOpacity={0.15} />
            <div className="w-20 h-[1px] bg-gradient-to-l from-transparent to-[#d5cabb]/60" />
          </div>
        </div>
        ...
        >
          <p className="text-[#8a7a65] font-serif italic text-base md:text-lg">
