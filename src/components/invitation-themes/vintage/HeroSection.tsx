  ...
  const invitationData = useInvitationData();
    ...
    return (
        <section className="relative min-h-screen flex flex-col items-center justify-center overflow-hidden bg-[#F4F1E1] text-[#5D534A]">
            ...
            <div
                className="absolute inset-0 bg-[url('/invitation-assets/vintage-bg.png')] bg-cover bg-center bg-no-repeat opacity-40 pointer-events-none mix-blend-multiply flex items-center justify-center"
            >
            </div>
