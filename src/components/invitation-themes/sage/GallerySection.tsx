...
export default function GallerySection() {
  ...
  return (
    <section ref={sectionRef} className="py-20 md:py-28 px-4 bg-white text-[#3a3f38] relative overflow-hidden">
      <div className="absolute inset-0 bg-[#e9eee7] opacity-20 pointer-events-none" />

      <div className="max-w-7xl mx-auto relative z-10">
        <div className={`text-center mb-12 md:mb-16 ${isVisible ? 'animate-fade-in-up' : 'opacity-0'}`}>
          <span className="text-[#8a9a86] tracking-[0.5em] text-[10px] uppercase font-sans block mb-4">
            Anılarımız
          </span>
          <h2 className="font-serif text-4xl md:text-5xl text-[#2c352b] mb-6">
            Bizim Hikayemiz
          </h2>
          <div className="flex items-center justify-center gap-4">
            <div className="w-20 h-[1px] bg-gradient-to-r from-transparent to-[#8a9a86]/50" />
            <Heart className="w-4 h-4 text-[#8a9a86]" strokeWidth={1.5} fill="#8a9a86" fillOpacity={0.15} />
            <div className="w-20 h-[1px] bg-gradient-to-l from-transparent to-[#8a9a86]/50" />
          </div>
        </div>
        ...
        >
          <p className="text-[#6b7a68] font-serif italic text-base md:text-lg">
