...
VALUES
  ('Sage Bahçe',     'sage-bahce',     ARRAY['/themes/sage/envelope.png',     '/themes/sage/bg.png'],
   'Adaçayı yeşili tonlarında, yumuşak çiçek motifleri ve cam efektli kart tasarımı ile zarif bir doğal davetiye.',
   259.00, true, 'sage'),
  ('Boho Krem',      'boho-krem',      ARRAY['/themes/boho/envelope.png',     '/themes/boho/bg.png'],
   'Krem ve toprak tonlarında, kemerli kart formu ve el yazısı tipografi ile sıcak boho davetiye tasarımı.',
   249.00, true, 'boho'),
  ('Bahar Çiçeği',   'bahar-cicegi',   ARRAY['/themes/blossom/envelope.png',  '/themes/blossom/hero-bg.png'],
